        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-5">
            ...
            <h3 className="text-2xl py-2 md:text-3xl dark:text-white">
              Technical Trainer and Process Improvement Engineer.
            </h3>
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-white">
              Skilled engineer specializing in technical training, leveraging
              programming expertise to educate and innovate. Proficient in
              enhancing business processes through tech-driven solutions and
              software engineering skills. Based in Tokyo, Japan.
            </p>
          </div>
